<?php
namespace ProcessMaker\Package\Pm3Container;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\Pm3Container\Http\Middleware\AddToMenus;
use ProcessMaker\Package\Pm3Container\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\Pm3Container\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'pm3-container');

        $this->publishes([
            __DIR__.'/../public' => public_path('vendor/processmaker/packages/pm3-container'),
        ], 'pm3-container');
