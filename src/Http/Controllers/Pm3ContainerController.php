<?php
namespace ProcessMaker\Package\Pm3Container\Http\Controllers;

use ProcessMaker\Http\Controllers\Controller;
use ProcessMaker\Http\Resources\ApiCollection;
use ProcessMaker\Package\Pm3Container\Models\Sample;
use RBAC;
use Illuminate\Http\Request;
use URL;


class Pm3ContainerController extends Controller
{
    public function index(){
        return view('pm3-container::index');
    }
