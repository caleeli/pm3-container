...
searchDirectoryFiles(getcwd() . '/', 'pm3-container', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'Pm3Container', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Pm3 Container', dashesToCamelCase($argv[1], true, ' '));
